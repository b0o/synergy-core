...
bool WebClient::getEdition(int &edition, QString &errorOut) {
...
bool WebClient::setEmail(QString email, QString &errorOut) {
  if (email.isEmpty()) {
...
bool WebClient::setPassword(QString password, QString &) {
  m_Password = password;
  return true;
}
