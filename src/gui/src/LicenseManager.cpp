...
std::pair<bool, QString> LicenseManager::setSerialKey(SerialKey serialKey,
                                                      bool acceptExpired) {
...
void LicenseManager::notifyUpdate(QString fromVersion, QString toVersion) {
...
SerialKey LicenseManager::serialKey() const { return m_serialKey; }
...
void LicenseManager::skipActivation() { notifyActivation("skip:unknown"); }
