        ...
        case 1:
          ...
          *static_cast<UInt8 *>(v) = buffer[0];
          LOG((CLOG_DEBUG2 "readf: read %d byte integer: %d (0x%x)", len,
               *static_cast<UInt8 *>(v), *static_cast<UInt8 *>(v)));
          break;

        case 2:
          // 2 byte integer
          *static_cast<UInt16 *>(v) =
              static_cast<UInt16>((static_cast<UInt16>(buffer[0]) << 8) |
                                  static_cast<UInt16>(buffer[1]));
          LOG((CLOG_DEBUG2 "readf: read %d byte integer: %d (0x%x)", len,
               *static_cast<UInt16 *>(v), *static_cast<UInt16 *>(v)));
          break;

        case 4:
          // 4 byte integer
          *static_cast<UInt32 *>(v) = (static_cast<UInt32>(buffer[0]) << 24) |
                                      (static_cast<UInt32>(buffer[1]) << 16) |
                                      (static_cast<UInt32>(buffer[2]) << 8) |
                                      static_cast<UInt32>(buffer[3]);
          LOG((CLOG_DEBUG2 "readf: read %d byte integer: %d (0x%x)", len,
               *static_cast<UInt32 *>(v), *static_cast<UInt32 *>(v)));
          break;
        }
        break;
      }
      ...
      case 'I': {
        ...
        case 1:
          ...
          for (UInt32 i = 0; i < n; ++i) {
            ...
            static_cast<std::vector<UInt8> *>(v)->push_back(buffer[0]);
            LOG((CLOG_DEBUG2 "readf: read %d byte integer[%d]: %d (0x%x)", len,
                 i, static_cast<std::vector<UInt8> *>(v)->back(),
                 static_cast<std::vector<UInt8> *>(v)->back()));
          }
          break;
          ...
          for (UInt32 i = 0; i < n; ++i) {
            ...
            static_cast<std::vector<UInt16> *>(v)->push_back(
                static_cast<UInt16>((static_cast<UInt16>(buffer[0]) << 8) |
                                    static_cast<UInt16>(buffer[1])));
            LOG((CLOG_DEBUG2 "readf: read %d byte integer[%d]: %d (0x%x)", len,
                 i, static_cast<std::vector<UInt16> *>(v)->back(),
                 static_cast<std::vector<UInt16> *>(v)->back()));
          }
          break;
        ...
        case 4:
          ...
          for (UInt32 i = 0; i < n; ++i) {
            ...
            static_cast<std::vector<UInt32> *>(v)->push_back(
                ...
                static_cast<UInt32>(buffer[3]));
            LOG((CLOG_DEBUG2 "readf: read %d byte integer[%d]: %d (0x%x)", len,
                 i, static_cast<std::vector<UInt32> *>(v)->back(),
                 static_cast<std::vector<UInt32> *>(v)->back()));
          }
          break;
        }
        break;
...
void ProtocolUtil::writef(void *buffer, const char *fmt, va_list args) {
