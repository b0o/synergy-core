...
bool SecureSocket::showCertificate() {
  X509 *cert;
  char *line;
...
void SecureSocket::showError(const char *reason) {
  if (reason != NULL) {
...
void SecureSocket::showSecureLibInfo() {
...
void SecureSocket::showSecureConnectInfo() {
