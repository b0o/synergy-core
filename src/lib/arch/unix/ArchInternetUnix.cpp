...
String ArchInternetUnix::get(const String &url) {
  CurlFacade curl;
  return curl.get(url);
}

String ArchInternetUnix::urlEncode(const String &url) {
  CurlFacade curl;
...
String CurlFacade::get(const String &url) {
...
String CurlFacade::urlEncode(const String &url) {
